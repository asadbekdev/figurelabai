...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "flex size-full flex-col overflow-hidden rounded-xl! border border-border bg-popover p-1 text-popover-foreground shadow-regular-md",
        className
      )}
      {...props}
    />
...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      <DialogContent
        className={cn(
          "top-1/3 translate-y-0 overflow-hidden rounded-2xl border border-border p-0",
          className
        )}
...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ms-auto text-sm tracking-widest text-muted-foreground group-data-selected/command-item:text-foreground",
        className
      )}
      {...props}
    />
